...
def df_wos_sd_fullrecord_metadata_fund_ack_fund_text(df):
...
if __name__ == '__main__':
    ...
    coluna = 'sd_fullrecord_metadata_fund_ack'

    caminho = f'{pasta_dados}/{coluna[3:]}/arquivo_wos_{coluna}_fund_text.parquet'

    tabela = pd.read_parquet(caminho)
    
    tabela = df_wos_sd_fullrecord_metadata_fund_ack_fund_text(tabela)
    
    table_name = 'WOS_SD_FR_FK_FUND_TEXT'
