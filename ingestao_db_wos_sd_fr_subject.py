...
def df_wos_sd_fullrecord_metadata_cat_subj(df):
    ...
    select_columns =   ['ID','CODE', 'CONTENT', 'ASCATYPE']
...
if __name__ == '__main__':
    ...
    coluna = 'sd_fullrecord_metadata_cat_subj'

    caminho = f'{pasta_dados}/{coluna[3:]}/arquivo_wos_{coluna}.parquet'

    tabela = pd.read_parquet(caminho)
    
    tabela = df_wos_sd_fullrecord_metadata_cat_subj(tabela)
    
    table_name = 'WOS_SD_FR_SUBJECT'
