...
def df_wos_dd_citation_related_tc_list(df):
    ...
    select_columns =   ['ID','COLL_ID', 'LOCAL_COUNT']
...
if __name__ == '__main__':
    ...
    coluna = 'dd_citation_related_tc_list'

    caminho = f'{pasta_dados}/{coluna[3:]}/arquivo_wos_{coluna}.parquet'

    tabela = pd.read_parquet(caminho)
    
    tabela = df_wos_dd_citation_related_tc_list(tabela)
    
    table_name = 'WOS_DD_CIT_REL_TC_LIST'
