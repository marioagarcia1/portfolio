...
def df_wos_dd_cr_identifiers(df):
...
if __name__ == '__main__':
    ...
    coluna = 'dd_cluster_related_identifiers_identifier'

    caminho = f'{pasta_dados}/{coluna[3:]}/arquivo_wos_{coluna}.parquet'

    tabela = pd.read_parquet(caminho)
    
    tabela = df_wos_dd_cr_identifiers(tabela)
    
    table_name = 'WOS_DD_CR_IDENTIFIERS'
    ...
    query_cria_tabela = f"""
                            CREATE TABLE {table_name} (
                                                        ...
                                                        "PMID" VARCHAR2(500), 
                                                        "ART_NO" VARCHAR2(500), 
                                                        "MEETING_ABS" VARCHAR2(500), 
                                                        "EISBN" VARCHAR2(500), 
                                                        "ISBN" VARCHAR2(500), 
                                                        "PARENT_BOOK_DOI" VARCHAR2(500), 
                                                        "XREF_DOI" VARCHAR2(500),
